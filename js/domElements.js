...
//  key: inputtype: ["Title of Container", "ID", "size in the form "left: #unit; top: #unit;", "Special Text Inside container", "Special Class"]
  var elementParams = { 
    ...
    checknum: {blankInput: ["Check Number", "check-num", "left: 7.0in; top: 0.33in;", "No. 1000", ""]},
    ...
    date: {contentInput: ["Date of Check", "date-line", ["left: 6.0in; top: 0.83in;", "left: 0.40in; bottom: 0.25in;"], "Date ______________", ""]},
    memo: {contentInput: ["Memo Line", "memo-line", ["left: 0.41in; top: 2.64in;", "left: 0.65in; bottom: 0.25in;"], "MEMO _________________________", ""]},
    payee: {contentInput: ["Payee Info", "payee-name", ["left: 0.37in; top: 1.28in;", "left: 0.85in; bottom: 0.25in;", "left: 7in; bottom: 0.25in;"], "Pay To The\nOrder Of __________________________________________________________________________ $ ___________", ""]},
    payment: {contentInput: ["Written Payment", "written-amount", ["left: 0.39in; top: 1.73in;", "left: 0.1in; bottom: 0.25in;"], "________________________________________________________________________________________ Dollars", ""]},
    sig: {contentInput: ["Signature Line", "sig-line", ["left: 5.49in; top: 2.34in;", "bottom: 0.45in;"], "____________________________\nAUTHORIZED SIGNATURE", ""]}
  };
